...
<%
    ...
    <tr>
        ...
        <td style="font-size: 18px;font-family: sans-serif;color: #3694ab">
            <a href="./addTrainsSeatsFirst?cdate=<%=cDate%>&trainno=<%=trainno%>&trainname=<%=trainname%>&sourcecity=<%=sourcecity%>&destinationcity=<%=destinationcity%>&distance=<%=distance%>&cost=<%=cost%>&totalSeat=<%=totalSeat%>&availableSeat=<%=availableSeat%>">Add Seat</a> </td>
